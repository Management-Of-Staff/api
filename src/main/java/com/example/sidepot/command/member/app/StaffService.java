...
import com.example.sidepot.command.member.domain.MemberFileRepository;
...
public class StaffService {
    ...
    @Transactional
    public ResponseDto registerStaff(MemberRegisterDto.MemberRegisterRequestDto memberRegisterRequestDto){
    ...
    public ResponseDto updateStaffPassword(LoginMember member,
                                           MemberUpdateDto.MemberUpdatePasswordRequestDto memberUpdatePasswordRequestDto) {
        Staff staff = memberValidator.verifyStaff(member.getMemberPhoneNum());
    ...
    public ResponseDto updateStaffPhone(LoginMember member,
                                        MemberUpdateDto.MemberUpdatePhoneRequestDto memberUpdatePhoneRequestDto) {
        Staff staff = memberValidator.verifyStaff(member.getMemberPhoneNum());
    ...
    @Transactional(readOnly = true)
    public MemberReadDto.StaffSearchResponseDto findStaffByPhoneNum(LoginMember member, MemberReadDto.StaffSearchRequestDto staffSearchRequestDto) {
        ...
        return MemberReadDto.StaffSearchResponseDto.of(staff);
    }
}
