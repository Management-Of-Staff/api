...
import com.example.sidepot.command.store.domain.*;
import com.example.sidepot.command.store.dto.TodoListCreateDto;
import com.example.sidepot.command.store.dto.TodoListResponseDto;
...
public class TodoListService {
    ...
    public void updateTodoListDetailList(TodoList todoList, List<TodoListCreateDto.TodoListDetailCreateDto> todoListDetailCreateDtoList){
        for(TodoListCreateDto.TodoListDetailCreateDto todoListDetailCreateDto : todoListDetailCreateDtoList){
    ...
    public void updateScheduleManagerList(TodoList todoList, List<TodoListCreateDto.ManagerCreateDto> managerCreateDtoList){
        for(TodoListCreateDto.ManagerCreateDto managerCreateDto : managerCreateDtoList){
    ...
    public void saveNewTodoListDetail(TodoList todoList, TodoListCreateDto.TodoListDetailCreateDto todoListDetailCreateDto){
    ...
    public void saveNewScheduleManager(TodoList todoList, TodoListCreateDto.ManagerCreateDto managerCreateDto){
