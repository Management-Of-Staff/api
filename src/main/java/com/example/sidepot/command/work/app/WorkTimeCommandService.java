...
public class WorkTimeCommandService {
    ...
    @Transactional
    public void createWorkTime(LoginMember member, WorkRequestDto.CreateWorkReqDto createWorkReqDto){
        //직접참조 필드 조회
    ...
    @Transactional
    public void deleteWorkTime(LoginMember member, WorkRequestDto.DeleteWorkReqDto deleteWorkReqDto){
    ...
    @Transactional
    public void updateWorTime(LoginMember member, WorkRequestDto.UpdateWorkReqDto updateWorkReqDto){
