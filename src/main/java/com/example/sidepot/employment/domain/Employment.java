...
//
//    public void createWorkSchedule(createWorkReqDto createWorkReqDto) {
//        createWorkReqDto.getDayOfWeekList().stream()
...
//    }
    ...
    public void checkOverlappingSchedule(Set<DayOfWeek> days, LocalTime startTime, LocalTime endTime){
        ...
        if (workTimeList.stream()
                .anyMatch(workTime ->
                        (checkStartTime.isAfter(workTime.getStartTime()) && checkStartTime.isBefore(workTime.getEndTime()) && days.contains(workTime.getDayOfWeek()))
                                || (checkEndTime.isAfter(workTime.getStartTime()) && checkEndTime.isBefore(workTime.getEndTime()) && days.contains(workTime.getDayOfWeek())))) {
