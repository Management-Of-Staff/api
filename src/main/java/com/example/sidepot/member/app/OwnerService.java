...
public class OwnerService {
    ...
    @Transactional
    public ResponseDto updateOwnerPassword(LoginMember member, MemberUpdatePasswordRequestDto memberUpdatePasswordRequestDto) {
        Owner owner = memberValidator.verifyOwner(member.getMemberPhoneNum());
    ...
    @Transactional
    public ResponseDto updateOwnerPhone(LoginMember member, MemberUpdatePhoneRequestDto memberUpdatePhoneRequestDto) {
        Owner owner = memberValidator.verifyOwner(member.getMemberPhoneNum());
