...
public class StaffController {
    ...
    @ApiOperation(value = "[직원] 회원가입", notes = "직원 회원 가입 API")
    @PostMapping(value = "/staff/sign-up")
    ...
    @PostMapping(value ="/staff/password-update")
    ...
    @PostMapping(value ="/staff/profile-update")
    ...
    @PostMapping(value ="/staff/password-check")
    ...
    @PostMapping(value ="/staff/phone-update]")
    public ResponseEntity<ResponseDto> updateOwnerProfileInfo(
                            @ApiIgnore @AuthenticationPrincipal LoginMember member,
